// Package bundle contains vendored type definitions from the
// operator-framework/operator-registry repository.
package bundle
...
// Property is a name/value pair used in operator-registry bundles.
